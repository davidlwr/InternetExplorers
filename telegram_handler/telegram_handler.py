...
def main():
    ...
    updater = Updater("648862608:AAFRNOOslL-my5PUxTCYzDgVTEJ_WMMjaZY")
    ...
    updater.dispatcher.add_handler(CommandHandler('toilet', toilet))
