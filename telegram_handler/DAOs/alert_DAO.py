...
def get_alert_by_id(chat_id, alert_text):
    '''
    Returns date,rname and rname by chat_id and alert_text
    '''
    query = "SELECT date, rname FROM {} WHERE chat_id = %s AND alert_text = %s".format(table_name)
