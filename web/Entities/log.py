...
class Log(object):
    '''
    This class represents entries into DB tables for BOTH 'SENSOR_LOG' and 'SYSMON_LOG'
    '''
    ...
    # write param defs
    def __init__(self, sensor_id, sensor_location, gateway_id, gateway_timestamp, key, reading_type, server_timestamp, value):
